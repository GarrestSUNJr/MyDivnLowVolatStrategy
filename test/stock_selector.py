...
from iFinDPy import *
#from iFinDPy import stock_selector
from sqlalchemy import create_engine
import sys
sys.path.append(r'C:\Users\DELL\jupyter\MFE5210AlgoTrad\MyDivnLowVolatStrategy\Concept-Factor\dependencies')#temporary store
